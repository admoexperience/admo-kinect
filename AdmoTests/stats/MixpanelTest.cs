    ...
    public class MixpanelTest
    {
        ...
        public void TestFormattingOfRequestForTrack()
        {
            ...
            Assert.AreEqual("https://api.mixpanel.com/track/?"+
                "data=eyJldmVudCI6IiRib3JuIiwicHJvcGVydGllcyI6eyJkaXN0aW5jdF9pZCI6NDgxLCJ0aW1lIjoxMzIxNDk5MzcxLCJ0b2tlbiI6IjEzZmUzZGRjODZlYjZmOTBjNGVlN2QwZDQ3NTYzMTUwIiwidW5pdE5hbWUiOiJ1bml0TmFtZSJ9fQ==", request);
        }
        ...
        private static Mixpanel CreateMp()
        {
            ...
            return new Mixpanel("7a7727f7880dc39463f99475e7cefcf8", "13fe3ddc86eb6f90c4ee7d0d47563150","unitName");
        }
